    ...
    <div className="hidden md:flex flex-col h-full bg-neutral-950 text-white w-64 shrink-0">
      <div className="p-6">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center shrink-0">
            <Image src="/images/euspl-logo-icon.png" alt="Logo" width={50} height={50} className="h-7 w-7"/>
          </div>
          <div>
            <p className="font-bold text-sm leading-tight">EUSPL</p>
      ...
      <div className="p-4">
        ...
        <Button
          variant="ghost"
          onClick={logout}
          className="w-full justify-start gap-2 text-neutral-500 hover:text-white hover:bg-neutral-800"
          size="sm"
        >
